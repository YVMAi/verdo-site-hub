          ...
          {isCollapsed ? (
                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild tooltip={item.title}>
                      <NavLink
                        to={item.url}
                        className={({ isActive }) =>
                          `group flex items-center justify-center w-12 h-12 p-0 rounded-xl text-gray-300 hover:text-white hover:bg-verdo-navy-light/40 transition-all duration-200 font-medium relative ${
                            isActive ? 'bg-verdo-jade/10 text-white shadow-lg before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-verdo-jade before:rounded-r-full' : ''
                          }`
                        }
                      >
            ...
            >
              <CollapsibleTrigger asChild>
                <SidebarGroupLabel 
                  className="group flex items-center justify-between px-3 py-3 text-gray-300 hover:text-white cursor-pointer rounded-xl hover:bg-verdo-navy-light/30 transition-all duration-200 font-medium"
                >
                      ...
                      <SidebarMenuItem key={item.title}>
                        <SidebarMenuButton asChild>
                          <NavLink
                            to={item.url}
                            className={({ isActive }) =>
                              `group flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-verdo-navy-light/40 transition-all duration-200 font-medium relative ml-4 ${
