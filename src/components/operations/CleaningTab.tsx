      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-1">
            <button onClick={() => setCleaningType('wet')} className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${cleaningType === 'wet' ? 'bg-verdo-navy text-white shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
              Wet Cleaning
            </button>
            <button onClick={() => setCleaningType('dry')} className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${cleaningType === 'dry' ? 'bg-verdo-navy text-white shadow-sm' : 'text-gray-600 hover:text-gray-900'}`}>
              Dry Cleaning
            </button>
          </div>
        </div>
