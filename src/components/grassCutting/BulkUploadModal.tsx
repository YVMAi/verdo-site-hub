...
export const BulkUploadModal: React.FC<BulkUploadModalProps> = ({ onUpload }) => {
  ...
  const downloadTemplate = () => {
    ...
    const sampleData = [
      '18-Aug-25,block-1-INV1,45,2,Sample remarks',
      '18-Aug-25,block-1-INV2,50,2,Sample remarks'
    ];
