            ...
            <table className="w-full text-xs border-collapse">
              ...
              <tbody>
                <tr className="bg-gray-100">
                  ...
                  {data.blocks.map(block => block.inverters.map(inverter => <td key={`total-${block.id}-${inverter.id}`} className={cn("px-2 py-1 text-center border border-gray-300 bg-gray-200", getColumnWidth(`${block.id}-${inverter.id}`))}>
                ...
                <tr className="bg-gray-100">
                  ...
                  {data.blocks.map(block => block.inverters.map(inverter => <td key={`percent-${block.id}-${inverter.id}`} className={cn("px-2 py-1 text-center border border-gray-300 bg-gray-200", getColumnWidth(`${block.id}-${inverter.id}`))}>
                ...
                return <td key={`input-${key}`} className={cn("px-2 py-1 text-center border border-gray-300 bg-blue-100", getColumnWidth(key))}>
